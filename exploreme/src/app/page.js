...
export default function Home() {
  ...
  return (
    <div className="flex w-full items-center min-h-[calc(100vh-4.6rem)] relative">
      ...
      <div className="absolute bottom-0 right-12">
        <Image 
            className='object-contain w-[500px] opacity-30'
            src="/bg.png"
            width={1000}
            height={1000}
            alt="bgpng"
      ...
      <div className="absolute bottom-52 left-[40rem]">
        <Image 
      ...
      <div className="absolute bottom-60 left-[42rem]">
        <Image 
            className='object-contain w-[300px] opacity-30'
            src="/bg.png"
            width={1000}
            height={1000}
            alt="bgpng"
