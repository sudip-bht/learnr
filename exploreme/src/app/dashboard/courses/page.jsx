      ...
      >
        ...
        <div className='flex gap-5 flex-wrap'>
          {enrollCourse.map((item) => (
            <div key={item.id} className='bg-slate-200 rounded-2xl p-5 flex flex-col space-y-2 items-center'>
              <div className='w-[300px] h-[300px]'>
                <Image src={item.img} alt='courseimg' className='object-cover w-full h-full rounded-2xl' width={300} height={300} />
              </div>
              <div>
